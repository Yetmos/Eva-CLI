...
This example is the V0.5 minimum runtime loop. It is a complete Eva workspace that can be loaded with:
...
2. `eva-runtime` builds the V0.5 in-memory services.
...
| `config/agents/root-agent/main.lua` | Controlled V0.5 `on_event` script. |
