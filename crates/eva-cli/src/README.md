...
| `run/version_cmd.rs` runtime marker | V1.13.7 已更新 | `version` / `--version` 输出新增 `mcp_http_auth_v1.13.6` 和 `mcp_compat_matrix_v1.13.7`，用于标识 MCP HTTP/auth transport boundary 与 compatibility matrix release gate。 |
