...
| `eva observability smoke` | 写入 V1.9.5 file JSONL observability backend，并在 V1.16.2 验证 tracing subscriber bridge、audit、runtime/provider/task metrics、OTel-style spans 和 best-effort degradation；支持 `--tracing-sink jsonl|dev-console`。 |
