...
| `eva daemon start/status/stop/shutdown/submit/cancel/drain/reload` | 验证 V1.12/V1.13.5/V1.15.4 daemon pid/lock/state、durable backend、provider/task recovery、policy、observability、hardware hotplug subscriber、shutdown contract 和本机 filesystem mailbox 控制面；不启动 provider 进程，也不暴露 raw hardware handle。 |
