...
| `eva-cli` | CLI parser、formatter、exit code、运行入口 | 已完成 V0.4 basic run | [README](eva-cli/README.md) |
| `eva-runtime` | 组合根、builder、service summary、basic loop | 已完成 V0.4 basic loop | [README](eva-runtime/README.md) |
| `eva-storage` | StateStore、EventLog、ArtifactStore | 已完成 V0.4 in-memory | [README](eva-storage/README.md) |
| `eva-eventbus` | publish、ack/fail、dead letter | 已完成 V0.4 in-memory | [README](eva-eventbus/README.md) |
| `eva-scheduler` | Topic 匹配、订阅表、mailbox 投递 | 已完成 V0.4 | [README](eva-scheduler/README.md) |
| `eva-agent` | Agent 生命周期、队列、事件处理 | 已完成 V0.4 | [README](eva-agent/README.md) |
| `eva-lua-host` | Lua loader、sandbox gate、受控 `on_event` contract | 已完成 V0.4 controlled contract | [README](eva-lua-host/README.md) |
...
| V0.5 | `eva-agent`、`eva-lua-host`、`eva-eventbus`、`eva-cli` | 任务状态、取消、超时、重试、热更新雏形 | 待实现 | 长任务可观察、可取消 |
