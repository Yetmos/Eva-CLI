...
There are 123 logical changes: 1 Ready, 115 Blocked, 0 In progress, 0 In verification, and 7 Done. Blocked here means a strict direct prerequisite is incomplete; read-only research may run earlier, but an implementation diff cannot enter In progress until its prerequisites are satisfied.
...
| W0-L08 | Coverage/freshness/trust policy | W0-L03 through W0-L07 | Ready | Producers, classification, platform provenance, and bundle consistency semantics are Done; enter In progress when consumer-owned coverage, freshness, uniqueness, and trusted-executor policy implementation begins |
