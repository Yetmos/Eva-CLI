...
There are 123 logical changes: 2 Ready, 119 Blocked, 0 In progress, 0 In verification, and 2 Done. Blocked here means a strict direct prerequisite is incomplete; read-only research may run earlier, but an implementation diff cannot enter In progress until its prerequisites are satisfied.
...
| W0-L03 | CLI evidence manifest and scope | W0-L01, W0-L02 | Ready | Both prerequisites are Done; enter In progress when manifest/profile/legacy normalization changes start |
