...
There are 123 logical changes: 1 Ready, 121 Blocked, 0 In progress, 0 In verification, and 1 Done. Blocked here means a strict direct prerequisite is incomplete; read-only research may run earlier, but an implementation diff cannot enter In progress until its prerequisites are satisfied.
...
| W0-L02 | Provenance and subject digest verification | W0-L01 | Ready | `W0-L01` is Done; enter In progress when digest recomputation, commit consistency, and mixed-commit rejection start |
