...
There are 123 logical changes: 2 Ready, 117 Blocked, 0 In progress, 0 In verification, and 4 Done. Blocked here means a strict direct prerequisite is incomplete; read-only research may run earlier, but an implementation diff cannot enter In progress until its prerequisites are satisfied.
...
| W0-L05 | Separate performance budget/measurement | W0-L01, W0-L04 | Ready | Gate evidence kinds are enforced; enter In progress when budget, synthetic/unmeasured, and real observation semantics are separated |
