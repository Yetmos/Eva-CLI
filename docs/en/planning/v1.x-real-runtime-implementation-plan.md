...
| W0-L03 | eva-cli/src/run/release_cmd.rs, eva-release/src/checklist.rs | CLI accepts four optional evidence files and can still report ready without them | Add a unified evidence manifest and alpha/production scope; normalize legacy inputs into envelopes | W0-L01, W0-L02 | Production without a manifest exits nonzero; alpha and production cannot impersonate each other |
...
There are 123 logical changes: 1 Ready, 122 Blocked, 0 In progress, 0 In verification, and 0 Done. Blocked here means a strict direct prerequisite is incomplete; read-only research may run earlier, but an implementation diff cannot enter In progress until its prerequisites are satisfied.
...
| --- | --- | --- | --- | --- |
| W0-L01 | Unified EvidenceEnvelope | No new prerequisite | Ready | Enter In progress when the schema/test diff starts; enter In verification after four-kind round-trip/rejection tests pass |
| W0-L02 | Provenance and subject digest verification | W0-L01 | Blocked | W0-L01 is Done |
| W0-L03 | CLI evidence manifest and scope | W0-L01, W0-L02 | Blocked | Both prerequisites are Done |
| W0-L04 | Declaration/fixture classification | W0-L01, W0-L03 | Blocked | Production scope contract is Done |
| W0-L05 | Separate performance budget/measurement | W0-L01, W0-L04 | Blocked | Evidence kind is enforced by gates |
| W0-L06 | Real command evidence capture | W0-L01, W0-L02 | Blocked | Envelope and digest verifier are Done |
