...
There are 123 logical changes: 2 Ready, 108 Blocked, 0 In progress, 0 In verification, and 13 Done. Blocked here means a strict direct prerequisite is incomplete; read-only research may run earlier, but an implementation diff cannot enter In progress until its prerequisites are satisfied.
...
| W1-L04 | Background spawn/handshake | W1-L03 | Ready | W1-L03 lease, heartbeat, PID identity, and stale-takeover contracts are Done; next implement parent/child spawn, ready handshake, and failure cleanup |
