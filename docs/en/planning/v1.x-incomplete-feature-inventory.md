...
| Provider and capability execution | W3-L01 through W3-L07 are done: real PID/CAS, process-group/Job cleanup, restart budgets, stdio/MCP registration, and cross-process admission exist; Linux/macOS/Windows evidence in run `29597430669` succeeded | W3-L08 run-as isolation, W3-L09 credential vault, W3-L10 daemon-owned supervision, and W3-L11 three-platform production evidence, including missing native Linux/macOS crash-loop/daemon-kill runs; TLS/streaming remain W4 work | P0 |
...
| Upgrade and service management | W2-L01/L02/L06 are done; `eva service install/status/start/stop/restart/uninstall` is wired, the Fake adapter requires explicit `--dev`, and its project/service-scoped development state survives CLI process boundaries; Windows Service, systemd, and launchd Adapter code remains in controlled lifecycle verification | W2-L03 through L05 real-host transcripts and W2-L07 through L10 daemon entrypoint, boot recovery, destructive harnesses, and production evidence; real candidate traffic switching remains incomplete | P0 |
...
| `platform_service_manager_test_environment` | Controlled Windows/Linux/macOS service hosts and elevation/login permissions | W2-L03 through L05 real-host transcripts, W2-L07 through L10 entrypoint/recovery/harness/gate, and W3-L11 production evidence; W2-L06 CLI code and contract are verified in-repository |
