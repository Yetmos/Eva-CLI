...
| Upgrade and service management | W2-L01/L02 are done; Windows Service, systemd, and launchd Adapter code exists and is in controlled lifecycle verification, while the fake adapter remains a unit-test boundary | W2-L06 through W2-L10: service CLI, daemon entrypoint, boot recovery, destructive harnesses, and production evidence; real candidate traffic switching remains incomplete | P0 |
...
| `platform_service_manager_test_environment` | Controlled Windows/Linux/macOS service hosts and elevation/login permissions | W2-L03 through L05 real-host transcripts, W2-L06 through L10 CLI/entrypoint/recovery/harness/gate, and W3-L11 production evidence |
