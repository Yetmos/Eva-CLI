...
| P5-004 | Link provider invocation audit to trace fields | `crates/eva-adapter`, `crates/eva-observability`, `crates/eva-cli` | CLI JSON includes trace/audit fields | In Progress | local |
