...
| P1-001 | Add OIDC/attestation permissions and Buildx SBOM/provenance settings to GHCR release job | `.github/workflows/release.yml` | Workflow diff review; `scripts/validate-version-management.ps1` | In Progress | pending |
