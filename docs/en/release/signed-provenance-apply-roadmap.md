...
| P1-003 | Update release body text to report GHCR provenance/SBOM availability | `.github/workflows/release.yml`, release docs | Release body generation review | In Progress | pending |
