...
| P1-002 | Extend `package-ghcr.json` with provenance and SBOM fields while preserving existing fields | `.github/workflows/release.yml`, release docs | `scripts/validate-version-management.ps1`; JSON field review | In Progress | pending |
