...
| --- | --- | --- | --- | --- | --- |
| P0-001 | Create this implementation ledger and register it in docs/site indexes | `docs/en/release/signed-provenance-apply-roadmap.md`, `docs/zh-CN/release/signed-provenance-apply-roadmap.md`, `docs/_i18n/manifest.json`, docs/site indexes | `scripts/build-site-i18n.ps1`; `scripts/validate-i18n.ps1`; `scripts/validate-version-management.ps1` | In Progress | pending |
| P1-001 | Add OIDC/attestation permissions and Buildx SBOM/provenance settings to GHCR release job | `.github/workflows/release.yml` | Workflow diff review; `scripts/validate-version-management.ps1` | Planned | pending |
| P1-002 | Extend `package-ghcr.json` with provenance and SBOM fields while preserving existing fields | `.github/workflows/release.yml`, release docs | `scripts/validate-version-management.ps1`; JSON field review | Planned | pending |
| P1-003 | Update release body text to report GHCR provenance/SBOM availability | `.github/workflows/release.yml`, release docs | Release body generation review | Planned | pending |
| P1-004 | Update website/docs to expose provenance status after the workflow change | `website/_i18n/*.json`, generated website pages, docs index | `scripts/build-site-i18n.ps1`; `scripts/validate-i18n.ps1` | Planned | pending |
...
| P4-004 | Add durable event/task state interface | `crates/eva-storage`, `crates/eva-runtime`, `crates/eva-cli` | task status/logs survive process boundary in tests | Planned | pending |
