...
| P6-002 | Implement restore apply dry-run validation over durable artifacts | `crates/eva-backup`, `crates/eva-cli` | digest mismatch and missing backup tests | In Progress | local |
