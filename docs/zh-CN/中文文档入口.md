...
V1.11.4-alpha CLI command module split 检查点：当前仓库包含可编译 Rust workspace、可执行 CLI
...
当前受管理项目版本：`V1.11.4-alpha`（`Cargo.toml` 版本 `1.11.4-alpha`，预发布 Git tag 形式 `v1.11.4-alpha`）。版本规则见 [版本管理方案](release/版本管理方案.md)。
