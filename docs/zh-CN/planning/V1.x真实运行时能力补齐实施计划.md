...
当前共有 123 个逻辑修改：0 个可开始、64 个已阻塞、0 个进行中、8 个验证中、51 个已完成。这里的“已阻塞”表示严格直接前置或明确的外部验收边界尚未满足，不表示不能先做只读调研；任何实现差异只有在前置满足后才能进入“进行中”。
...
| W3 | 11 | 0 | 0 | 2 | 0 | 2 | 7 | 0 | 0 | Open + EXT-01 |
...
| W3-L10 | Daemon-owned supervisor lifecycle | W1-L11、W3-L05 至 W3-L09 | 已阻塞 | W3-L08 identity 与 W3-L09 vault boundary 仍是前置，同时还需 cleanup/restart/admission contract |
