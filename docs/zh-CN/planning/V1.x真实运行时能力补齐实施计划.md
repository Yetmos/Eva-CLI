...
当前共有 123 个逻辑修改：1 个可开始、73 个已阻塞、0 个进行中、7 个验证中、42 个已完成。这里的“已阻塞”表示严格直接前置尚未完成，不表示不能先做只读调研；任何实现差异只有在前置满足后才能进入“进行中”。
...
| W6 | 11 | 1 | 0 | 6 | 0 | 0 | 4 | 0 | 0 | Open + DEC-02 |
...
| W6-L05 | Atomic config/policy/route swap | W6-L04、W1-L06 | 可开始 | W6-L04 与 W1-L06 已完成，可实现统一 generation pointer 与请求代际 pinning |
