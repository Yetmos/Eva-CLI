...
当前共有 123 个逻辑修改：1 个可开始、71 个已阻塞、0 个进行中、7 个验证中、44 个已完成。这里的“已阻塞”表示严格直接前置尚未完成，不表示不能先做只读调研；任何实现差异只有在前置满足后才能进入“进行中”。
...
| W6 | 11 | 1 | 0 | 4 | 0 | 0 | 6 | 0 | 0 | Open + DEC-02 |
...
| W6-L07 | Cancellable discovery deadline | W1-L12、W6-L02 | 可开始 | cancel owner 与 discovery config generation 已完成 |
