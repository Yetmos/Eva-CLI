...
| W3-L06 | Durable restart controller | W3-L02、W3-L05 | 可开始 | process record 与 cleanup 已完成；下一步实现跨 daemon generation 保留 attempt/budget、指数 backoff/jitter 与稳定运行后重置 |
