...
当前共有 123 个逻辑修改：2 个可开始、69 个已阻塞、0 个进行中、7 个验证中、45 个已完成。这里的“已阻塞”表示严格直接前置尚未完成，不表示不能先做只读调研；任何实现差异只有在前置满足后才能进入“进行中”。
...
| W6 | 11 | 2 | 0 | 2 | 0 | 0 | 7 | 0 | 0 | Open + DEC-02 |
...
| W6-L08 | Real PATH resolution/probe | W6-L07 | 可开始 | cancellable source contract 已完成 |
| W6-L09 | Registry TLS/auth/protocol client | W6-L07、DEC-02 | 已阻塞 | source contract 与 registry 决策完成 |
| W6-L10 | Durable TTL discovery cache | W6-L07 | 可开始 | source result/failure semantics 已完成 |
