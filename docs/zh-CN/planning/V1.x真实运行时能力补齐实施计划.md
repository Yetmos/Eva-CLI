...
| W6 | 11 | 0 | 0 | 10 | 0 | 1 | 0 | 0 | 0 | Open + DEC-02 |
| W7 | 12 | 0 | 0 | 11 | 0 | 0 | 1 | 0 | 0 | Open + EXT-04 |
| W8 | 12 | 0 | 0 | 7 | 1 | 2 | 2 | 0 | 0 | Open + EXT-05/EXT-09 |
...
| W8-L04 | Daemon memory/retrieval worker | W8-L03 | 进行中 | 新增强类型、默认禁用的 `runtime.retrieval_worker` 配置；启用时要求 agent/capability/provider/query/positive interval 完整，禁用或缺失不推断 production source。下一步接入 daemon-owned adapter-backed retrieval execution |
