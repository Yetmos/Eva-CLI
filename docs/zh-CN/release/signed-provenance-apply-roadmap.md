...
| P2-001 | 增加 native binary 的 release archive 命名和 manifest schema | release docs、`.github/workflows/release.yml` | workflow review；release evidence 字段审查 | In Progress | pending |
