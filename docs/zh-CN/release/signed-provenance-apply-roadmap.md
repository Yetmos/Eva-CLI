...
| P1-001 | 为 GHCR release job 增加 OIDC/attestation 权限和 Buildx SBOM/provenance 设置 | `.github/workflows/release.yml` | workflow diff review；`scripts/validate-version-management.ps1` | In Progress | pending |
