...
| P5-004 | 将 provider invocation audit 关联 trace fields | `crates/eva-adapter`、`crates/eva-observability`、`crates/eva-cli` | CLI JSON 包含 trace/audit fields | In Progress | local |
