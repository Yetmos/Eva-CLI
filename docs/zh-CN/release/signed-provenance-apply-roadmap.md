...
| P1-002 | 扩展 `package-ghcr.json`，记录 provenance 和 SBOM 字段，同时保留旧字段 | `.github/workflows/release.yml`、release docs | `scripts/validate-version-management.ps1`；JSON 字段审查 | In Progress | pending |
