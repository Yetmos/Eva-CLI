...
| P1-004 | workflow 变更后同步官网/文档中的 provenance 状态 | `website/_i18n/*.json`、生成后的官网页面、docs index | `scripts/build-site-i18n.ps1`；`scripts/validate-i18n.ps1` | In Progress | pending |
