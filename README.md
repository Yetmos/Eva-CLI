...
- Durable Scheduler, runtime audit wiring, policy-driven memory redaction/audit,
  and backup stores beyond the current durable EventBus/task snapshot/audit
  sink baseline, V1.15.7 provider retrieval executor, and local diagnostic
  surfaces.
