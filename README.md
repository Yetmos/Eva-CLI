...
restore mutation/rollback, service-manager abstraction, hardware permission and
  ...
  V1.17.3 high-risk apply text summaries.
...
evidence, V1.17.3 high-risk apply text evidence, and V1.11.5 `emit`, `agent`,
and `capability` command evidence. Later release tags that
